...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 backdrop-blur-md bg-purple-50/90 dark:bg-gradient-to-r dark:from-[#2D1B4B]/90 dark:to-[#3D2060]/90 border-b border-purple-400/20 shadow-lg px-4 py-3 flex items-center justify-between">
